...
public class Environement extends Agent {
  ...
  @SyntheticMember
  public Environement(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public Environement(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public Environement(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
